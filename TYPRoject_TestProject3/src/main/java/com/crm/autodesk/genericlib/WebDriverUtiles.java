...
public class WebDriverUtiles {
    ...
    */
	...
	/**
	 * used to select the option from the dropdown based on position / index (index always start from 0)
	 * @param element
	 * @param index
	 */
    ...
    * @param actSuccessfullMsg
    * @param purchaseSub
    * @param message
    */
   
   public void assertstmt(String actSuccessfullMsg,String purchaseSub,String message) {
	   
   
   try {
		Assert.assertTrue(actSuccessfullMsg.contains(purchaseSub));
	} catch (AssertionError e) {
	    System.out.println(""+purchaseSub+"creation unsuccesfull");
	    throw e;
	}
	System.out.println(""+purchaseSub+" "+message+"succesfully created");
   }
    ...
    * @param urlindex
    */
   public void assertstmtforDelete(String actSuccessfullMsg,String purchaseSub,String message,String urlindex) {
	   
	   
	   try {
			Assert.assertTrue(actSuccessfullMsg.contains(urlindex));
		} catch (AssertionError e) {
		    System.out.println(""+purchaseSub+"creation unsuccesfull");
		    throw e;
		}
